...
public class LoginController {
    ...
    //http://localhost:8080/api/send-otp-for-login?email=0902it191058@rjit.ac.in
    ...
    //http://localhost:8080/api/verify-otp-for-login?email=0902it191058@rjit.ac.in&otp=
